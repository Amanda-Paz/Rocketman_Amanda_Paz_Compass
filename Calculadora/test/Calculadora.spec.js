...
it  ('Deve somar -vazio -e 25 resultando em (ERRO)', () => {
...
it  ('Deve somar 25 e -vazio- resultando em (ERRO)', () => {

   let  resultado = Calculadora.soma (25,'vazio')
...
it  ('Deve subtrair 2 de 5 resultando em -4 (ERRO)', () => {
...
describe ('Testes de Raiz Quadrada ', () => {
 ...
 describe ('Testes de porcentagem ', () => {
    ...
    it ('Deve mostrar 5 % de 25', () => {
     ...
     it  ('Deve mostrar 50 % de -vazio -(ERRO)', () => {

      let  resultado = Calculadora.por(100, )

      expect(resultado).to.be.eq(15)
   })  

   it  ('Deve mostrar 50 % de x (ERRO)', () => {

      let  resultado = Calculadora.por(100,x)
